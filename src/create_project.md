...
The easiest way to start a new project is using the [esp-template](https://github.com/esp-rs/esp-template)
...
- .gitignore
    - this tells `git` which folders and files to ignore
- Cargo.toml
    - the usual Cargo [manifest](https://doc.rust-lang.org/cargo/reference/manifest.html) declaring some meta-data and dependencies of the project
...
- .cargo/config.toml
    - the Cargo [configuration](https://doc.rust-lang.org/cargo/reference/config.html)
